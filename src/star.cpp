...
bool Star::Initialize(QOpenGLFunctions * functions)
{
  ...
  m_maxAttr = m_program->uniformLocation("max");
...
void Star::Render(QOpenGLTexture * texture, QVector2D const & position,
